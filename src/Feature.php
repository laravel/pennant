 ...
 * @method static \Illuminate\Validation\Rules\RequiredIf requiredIfActive(\BackedEnum|\UnitEnum|string $feature)
 * @method static \Illuminate\Validation\Rules\RequiredIf requiredIfInactive(\BackedEnum|\UnitEnum|string $feature)
 * @method static \Illuminate\Validation\Rules\ProhibitedIf prohibitedIfActive(\BackedEnum|\UnitEnum|string $feature)
 * @method static \Illuminate\Validation\Rules\ProhibitedIf prohibitedIfInactive(\BackedEnum|\UnitEnum|string $feature)
 * @method static \Illuminate\Validation\Rules\ExcludeIf excludeIfActive(\BackedEnum|\UnitEnum|string $feature)
 * @method static \Illuminate\Validation\Rules\ExcludeIf excludeIfInactive(\BackedEnum|\UnitEnum|string $feature)
