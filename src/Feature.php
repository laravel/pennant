 ...
 * @method static void define(string|\BackedEnum|\UnitEnum $feature, mixed $resolver = null)
 ...
 * @method static void activateForEveryone(string|\BackedEnum|\UnitEnum|array $feature, mixed $value = true)
 * @method static void deactivateForEveryone(string|\BackedEnum|\UnitEnum|array $feature)
 * @method static void purge(string|\BackedEnum|\UnitEnum|array|null $features = null)
 * @method static string name(string|\BackedEnum|\UnitEnum $feature)
 * @method static array nameMap()
 * @method static mixed instance(string|\BackedEnum|\UnitEnum $name)
 ...
 * @method static array load(string|\BackedEnum|\UnitEnum|array $features)
 * @method static array loadMissing(string|\BackedEnum|\UnitEnum|array $features)
 * @method static array loadAll()
 * @method static mixed value(string|\BackedEnum|\UnitEnum $feature)
 * @method static array values(array $features)
 * @method static array all()
 * @method static bool active(string|\BackedEnum|\UnitEnum $feature)
 * @method static bool allAreActive(array $features)
 * @method static bool someAreActive(array $features)
 * @method static bool inactive(string|\BackedEnum|\UnitEnum $feature)
 * @method static bool allAreInactive(array $features)
 * @method static bool someAreInactive(array $features)
 * @method static mixed when(string|\BackedEnum|\UnitEnum $feature, \Closure $whenActive, \Closure|null $whenInactive = null)
 * @method static mixed unless(string|\BackedEnum|\UnitEnum $feature, \Closure $whenInactive, \Closure|null $whenActive = null)
 * @method static void activate(string|\BackedEnum|\UnitEnum|array $feature, mixed $value = true)
 * @method static void deactivate(string|\BackedEnum|\UnitEnum|array $feature)
 * @method static void forget(string|\BackedEnum|\UnitEnum|array $features)
 *
 * @see FeatureManager
 */
